...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/top-view-three-blue-paint-brush-strokes_23-2148815426.jpg",
          alt: "Artist portrait 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/top-view-creative-blue-paint-brush-strokes-surface_23-2148815443.jpg",
          alt: "Artist portrait 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/flat-lay-mixed-painting-colors_23-2148636828.jpg",
          alt: "Artist portrait 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/female-painter-posing-with-empty-palette-brush_114579-31186.jpg",
      ...
      features={[
        {
          id: "1",
          title: "Smart Brushes",
          author: "Precision Engine",
          description: "Adaptive brush dynamics that react to every nuance.",
          tags: [
            "AI",
            "Tech",
          ],
        ...
        },
        {
          ...
          author: "Layer Studio",
          description: "Complex composition management for professional results.",
          tags: [
            "Efficiency",
            "Layering",
          ],
        ...
        },
        {
          ...
          title: "Color Harmony",
          author: "Color Logic",
          description: "Intelligent color palettes that ensure visual balance.",
          tags: [
            "Creative",
            "Color",
          ],
      ...
      metrics={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/young-woman-enjoying-life-offline_23-2149172715.jpg",
        },
        {
          id: "2",
          value: "500+",
          title: "Custom Brushes",
          description: "High-quality presets included.",
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/smear-blue-paint-blue_23-2147746828.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Clara S.",
          role: "Digital Artist",
          testimonial: "Truly revolutionary brush engine.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-professional-female-artist-painting-canvas_273443-455.jpg",
        },
        {
          id: "2",
          name: "Marc L.",
          role: "Illustrator",
          testimonial: "Everything feels so natural to use.",
        ...
        },
        {
          ...
          name: "Elena P.",
          role: "Designer",
          testimonial: "Perfect for my workflow.",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-career-guidance-items-designers_23-2149443526.jpg",
        },
        {
          id: "4",
          name: "Javier D.",
          role: "Artist",
          testimonial: "Reliability like no other app.",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-painting-tool_23-2148467277.jpg",
        },
        {
          id: "5",
          name: "Sofia R.",
          role: "Painter",
          testimonial: "I love the new layer features.",
          imageSrc: "http://img.b2bpic.net/free-photo/digital-art-style-illustration-graphic-designer_23-2151536941.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, ArtPaint works seamlessly on macOS, Windows, and iPadOS.",
        },
        {
          id: "2",
          title: "Can I import brushes?",
          content: "Absolutely! You can import custom brush files easily.",
        },
        {
          id: "3",
          title: "Do you offer tutorials?",
          content: "We have an extensive library of video tutorials available.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      description="Send us your email and we'll keep you updated with the latest features."
      inputs={[
        {
          name: "name",
          type: "text",
